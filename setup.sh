...
REPO_CONFIG="\
LAYER@https://github.com/MontaVista-OpenSourceTechnology/poky.git;branch=zeus;layer=meta \
LAYER@https://github.com/MontaVista-OpenSourceTechnology/poky.git;branch=zeus;layer=meta-poky \
LAYER@https://github.com/MontaVista-OpenSourceTechnology/poky.git;branch=zeus;layer=meta-yocto-bsp \
LAYER@https://github.com/MontaVista-OpenSourceTechnology/meta-openembedded.git;branch=zeus;layer=meta-oe \
LAYER@https://github.com/MontaVista-OpenSourceTechnology/meta-openembedded.git;branch=zeus;layer=meta-python \
LAYER@https://github.com/MontaVista-OpenSourceTechnology/meta-openembedded.git;branch=zeus;layer=meta-filesystems \
LAYER@https://github.com/MontaVista-OpenSourceTechnology/meta-openembedded.git;branch=zeus;layer=meta-networking \
LAYER@https://github.com/MontaVista-OpenSourceTechnology/meta-openembedded.git;branch=zeus;layer=meta-webserver \
LAYER@https://github.com/MontaVista-OpenSourceTechnology/meta-clang.git;branch=zeus \
LAYER@https://github.com/MontaVista-OpenSourceTechnology/meta-selinux.git;branch=zeus \
LAYER@https://github.com/MontaVista-OpenSourceTechnology/meta-virtualization.git;branch=zeus \
LAYER@https://github.com/MontaVista-OpenSourceTechnology/meta-montavista-cgx.git;branch=zeus \
LAYER@https://github.com/MontaVista-OpenSourceTechnology/meta-openembedded.git;branch=zeus;layer=meta-perl \
LAYER@https://github.com/MontaVista-OpenSourceTechnology/meta-openembedded.git;branch=zeus;layer=meta-gnome \
LAYER@https://github.com/MontaVista-OpenSourceTechnology/meta-openembedded.git;branch=zeus;layer=meta-multimedia \
LAYER@https://github.com/MontaVista-OpenSourceTechnology/meta-openembedded.git;branch=zeus;layer=meta-xfce \
LAYER@https://github.com/MontaVista-OpenSourceTechnology/meta-security.git;branch=zeus \
LAYER@https://github.com/MontaVista-OpenSourceTechnology/meta-cgl.git;branch=master;layer=meta-cgl-common \
LAYER@https://github.com/MontaVista-OpenSourceTechnology/meta-cloud-services.git;branch=zeus \
LAYER@https://github.com/MontaVista-OpenSourceTechnology/meta-cloud-services.git;branch=zeus;layer=meta-openstack \
LAYER@https://github.com/MontaVista-OpenSourceTechnology/meta-montavista-cgl;branch=zeus \
LAYER@https://github.com/MontaVista-OpenSourceTechnology/meta-montavista-x86-generic-4.19.git;branch=zeus \

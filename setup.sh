...
REPO_CONFIG="\
LAYER@https://github.com/MontaVista-OpenSourceTechnology/poky.git;branch=honister;layer=meta \
LAYER@https://github.com/MontaVista-OpenSourceTechnology/poky.git;branch=honister;layer=meta-poky \
LAYER@https://github.com/MontaVista-OpenSourceTechnology/poky.git;branch=honister;layer=meta-yocto-bsp \
LAYER@https://github.com/MontaVista-OpenSourceTechnology/meta-openembedded.git;branch=honister;layer=meta-oe \
LAYER@https://github.com/MontaVista-OpenSourceTechnology/meta-openembedded.git;branch=honister;layer=meta-python \
LAYER@https://github.com/MontaVista-OpenSourceTechnology/meta-openembedded.git;branch=honister;layer=meta-filesystems \
LAYER@https://github.com/MontaVista-OpenSourceTechnology/meta-openembedded.git;branch=honister;layer=meta-networking \
LAYER@https://github.com/MontaVista-OpenSourceTechnology/meta-openembedded.git;branch=honister;layer=meta-webserver \
LAYER@https://github.com/MontaVista-OpenSourceTechnology/meta-clang.git;branch=honister \
LAYER@https://github.com/MontaVista-OpenSourceTechnology/meta-selinux.git;branch=honister \
LAYER@https://github.com/MontaVista-OpenSourceTechnology/meta-virtualization.git;branch=honister \
LAYER@https://github.com/MontaVista-OpenSourceTechnology/meta-montavista-cgx.git;branch=honister \
LAYER@https://github.com/MontaVista-OpenSourceTechnology/meta-openembedded.git;branch=honister;layer=meta-perl \
LAYER@https://github.com/MontaVista-OpenSourceTechnology/meta-openembedded.git;branch=honister;layer=meta-gnome \
LAYER@https://github.com/MontaVista-OpenSourceTechnology/meta-openembedded.git;branch=honister;layer=meta-multimedia \
LAYER@https://github.com/MontaVista-OpenSourceTechnology/meta-openembedded.git;branch=honister;layer=meta-xfce \
LAYER@https://github.com/MontaVista-OpenSourceTechnology/meta-security.git;branch=honister \
LAYER@https://github.com/MontaVista-OpenSourceTechnology/meta-cgl.git;branch=honister;layer=meta-cgl-common \
LAYER@https://github.com/MontaVista-OpenSourceTechnology/meta-cloud-services.git;branch=honister \
LAYER@https://github.com/MontaVista-OpenSourceTechnology/meta-cloud-services.git;branch=honister;layer=meta-openstack \
LAYER@https://github.com/MontaVista-OpenSourceTechnology/meta-montavista-cgl;branch=honister \
LAYER@https://github.com/MontaVista-OpenSourceTechnology/meta-montavista-x86-generic;branch=honister \
LAYER@https://github.com/MontaVista-OpenSourceTechnology/meta-qa.git;branch=honister;layer=meta-qa-framework \
LAYER@https://github.com/MontaVista-OpenSourceTechnology/meta-qa.git;branch=honister;layer=meta-qa-testsuites \

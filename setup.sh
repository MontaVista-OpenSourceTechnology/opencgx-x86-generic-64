...
REPO_CONFIG="\
LAYER@https://github.com/MontaVista-OpenSourceTechnology/openembedded-core;branch=wrynose;layer=meta \
...
LAYER@https://github.com/MontaVista-OpenSourceTechnology/meta-montavista-x86-generic;branch=wrynose \

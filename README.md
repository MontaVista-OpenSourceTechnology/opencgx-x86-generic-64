...
```
git clone --recursive https://github.com/MontaVista-OpenSourceTechnology/opencgx-x86-generic-64-4.14-2.5
cd opencgx-x86-generic-64-4.14-2.5
source setup.sh
```
...
================
```
opencgx-x86-generic-64-4.14-2.5/
